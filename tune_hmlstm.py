...
parameters1 = [
        ...
        {"name": "embedding_size_input", "type": "fixed", "value": 32},
        {"name": "hidden_size0", "type": "range", "bounds": [1, 256]},
        {"name": "hidden_size1", "type": "range", "bounds": [1, 256]},
        {"name": "hidden_size2", "type": "range", "bounds": [1, 256]},
        {"name": "embedding_size_output", "type": "fixed", "value": 256},
        {"name": "linear_size0", "type": "fixed", "value": 128},
        {"name": "output_size", "type": "fixed", "value": dataset.vocab_len()},
        {"name": "lr", "type": "range", "bounds": [0.0005, 0.05], "log_scale": True},
        {"name": "epochs", "type": "fixed", "value": 3},
    ]
...
parameters2 = [
        ...
        {"name": "hidden_size1", "type": "fixed", "value": 256},
        {"name": "hidden_size2", "type": "fixed", "value": 256},
        {"name": "embedding_size_output", "type": "range", "bounds": [1, 256]},
        {"name": "linear_size0", "type": "range", "bounds": [1, 256]},
        {"name": "output_size", "type": "fixed", "value": dataset.vocab_len()},
        {"name": "lr", "type": "range", "bounds": [0.0005, 0.05], "log_scale": True},
        {"name": "epochs", "type": "fixed", "value": 3},
    ]
